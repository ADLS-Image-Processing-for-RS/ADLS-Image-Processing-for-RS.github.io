...
1. Downlaod and import the elevation of Luxembourg from moodle (CW43 → Datasets) 

2. Caluculate the mean, maxaximum and minimum elevation values
...
9. Download a Sentinel 2 Image from [browser.dataspace.copernicus.eu](https://browser.dataspace.copernicus.eu/) for a location of your choosing. Import it as a raster image in R. Note that you have to import the individual bands and then recombine the image to a multiband raster.

10. Create a True-Color RGB Image and a False-Color NirGB Image using the appropriate bands (see [Spectral Bands (Wikipedia)](https://en.wikipedia.org/wiki/Sentinel-2#Spectral_bands))

11. Calculate NDVI of the Sentinel 2 Image using the appropriate bands
