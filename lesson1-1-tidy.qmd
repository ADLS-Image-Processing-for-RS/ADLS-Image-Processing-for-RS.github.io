...
:::{.notes}
- Dramatic reduction in memory usage - this is why rasters use this format
- The 8x multiplication accounts for all variables in the original dataset
- This efficiency becomes critical with large spatial datasets
- Connect this to why satellite imagery naturally fits wide format
:::
...
- Ask if you are struggling. Tasking builds understanding as well!
:::
...
2. Convert the data from long to wide

3. Convert the data to a matrix

4. Calculate mean unemployment first using the original dataframe, then the new matrix. Compare the speed difference.
