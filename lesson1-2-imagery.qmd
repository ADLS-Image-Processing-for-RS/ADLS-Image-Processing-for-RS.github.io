...
- Imagery data is composed of measurements at descrete locations (pixels) along two or more axes
...
writeRaster(volcano_rast, "data/volcano_rast.tif", overwrite = TRUE)

volcano_rast <- volcano_rast |> 
  aggregate(5, na.rm = TRUE) |> 
  as.int()

writeRaster(volcano_rast, "data/volcano_lowres.tif", overwrite = TRUE)
